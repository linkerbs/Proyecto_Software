...
class MatrizJun2004
{
    ...
    public function getAlumbrado($metros, $tipo_luminaria, $area_superficial)
    {
        if ($area_superficial < 200) {
            ...
            if ($tipo_luminaria == "A") {
                $alumbrado = $metros * 0.5015;
            } else if ($tipo_luminaria == "B") {
                $alumbrado = $metros * 0.3514;
            } else if ($tipo_luminaria == "C") {
                $alumbrado = $metros * 0.2586;
            } else {
                $alumbrado = $metros * 0.1701;
            }
        } else if ($area_superficial >= 500 && $area_superficial < 1000) {
            if ($tipo_luminaria == "A") {
                $alumbrado = $metros * 0.7186;
            } else if ($tipo_luminaria == "B") {
                $alumbrado = $metros * 0.4743;
            } else if ($tipo_luminaria == "C") {
                $alumbrado = $metros * 0.2586;
            } else {
                $alumbrado = $metros * 0.1971;
            }
        } else {
            if ($tipo_luminaria == "A") {
                $alumbrado = $metros * 1.1501;
            } else if ($tipo_luminaria == "B") {
                $alumbrado = $metros * 0.7186;
            } else if ($tipo_luminaria == "C") {
                $alumbrado = $metros * 0.36;
            } else {
                $alumbrado = $metros * 0.2514;
            }
        }
        return $alumbrado;
    }
    ...
    {
        $disposicion_final = $area_disfinal * 0.02;
        if ($disposicion_final < 1) {
            $disposicion_final = 1;
        }
    ...
    public function getDisposicionFinalHabitacional($area_disfinal)
    {
        ...
        if ($area_disfinal <= 70) {
            ...
            $disposicion_final = $area_disfinal * 0.009;
        } else if ($area_disfinal > 200 && $area_disfinal <= 500) {
            $disposicion_final = $area_disfinal * 0.0095;
        } else if ($area_disfinal > 500 && $area_disfinal <= 1000) {
            $disposicion_final = $area_disfinal * 0.01;
        } else if ($area_disfinal > 1000 && $area_disfinal <= 2650) {
            $disposicion_final = $area_disfinal * 0.015;
        } else {
            $disposicion_final = 38.40;
        }
        if ($disposicion_final < 0.64) {
            $disposicion_final = 0.64;
        } else if ($disposicion_final > 38.40) {
            $disposicion_final = 38.40;
        }
        return $disposicion_final;
    }
    ...
    public function getContribucionEspecialHabitacional($area_cont)
    {
        if ($area_cont <= 70) {
            ...
            $contribucion_especial = $area_cont * 0.00667;
            ...
            $contribucion_especial = $area_cont * 0.01333;
        } else {
    ...
    public function getAseoHabitacional($area_fin)
    {
        if ($area_fin < 70) {
            ...
            $aseo = $area_fin * 0.0224;
        } else if ($area_fin >= 500 && $area_fin < 1000) {
            $aseo = $area_fin * 0.0234;
        } else {
            $aseo = $area_fin * 0.0255;
        }
        return $aseo;
    }
    ...
    public function getAseoAreaComun($tipo, $area_comun)
    {
        $aseo = 0;
        if ($tipo === "habitacional") {
            $aseo = $area_comun * 0.0255;
        } else {
            // Usos varios
            $aseo = $area_comun * 0.0635;
        }
        return $aseo;
    }
